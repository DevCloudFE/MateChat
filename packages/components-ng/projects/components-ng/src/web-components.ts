...
platformBrowserDynamic()
  ...
  .then(({ injector }) => {
    ...
    try {
      ...
      const HeaderBasicWebComponent = createCustomElement(HeaderBasicShowComponent, {
        injector: injector,
      });
      const HeaderLogoClickWebComponent = createCustomElement(HeaderLogoClickShowComponent, {
        injector: injector,
      });
      const HeaderCustomOperationWebComponent = createCustomElement(HeaderCustomOperationShowComponent, {
        injector: injector,
      });
      // 将Toolbar组件转换为 web component
      const ToolbarBasicWebComponent = createCustomElement(ToolbarBasicShowComponent, {
        injector: injector,
      });
      const ToolbarSizeWebComponent = createCustomElement(ToolbarSizeShowComponent, {
        injector: injector,
      });
      const ToolbarSlotWebComponent = createCustomElement(ToolbarSlotShowComponent, {
        injector: injector,
      });
      const ToolbarUseIconWebComponent = createCustomElement(ToolbarUseIconShowComponent, {
        injector: injector,
      });
      ...
      customElements.define('mc-ng-header-logo-click', HeaderLogoClickWebComponent);
      customElements.define('mc-ng-header-custom-operation', HeaderCustomOperationWebComponent);
      ...
      customElements.define('mc-ng-toolbar-use-icon', ToolbarUseIconWebComponent);
    } catch (error) {
