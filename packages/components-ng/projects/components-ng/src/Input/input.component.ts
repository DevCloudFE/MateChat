import { Component, Input, Output, EventEmitter, OnInit, ViewChild, ElementRef, ContentChild, TemplateRef } from '@angular/core';
...
@Component({
  ...
  providers: [
    { provide: inputContextToken, useExisting: InputComponent }
  ]
  ...
  @Input() submitShortKey: SubmitShortKey | null | string = SubmitShortKey.Enter;
  ...
  onKeydown(event: KeyboardEvent): void {
    ...
    const shiftKey = 
      this.submitShortKey === SubmitShortKey.Enter ? !event.shiftKey :
      this.submitShortKey === SubmitShortKey.ShiftEnter ? event.shiftKey :
      false;
