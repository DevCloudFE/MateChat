...
import { DEFAULT_AVATAR_HEIGHT, DEFAULT_AVATAR_WIDTH } from './bubble-constants';
import { props } from './bubble-types';
import Avatar from './components/Avatar.vue';
import { useBubbleFoundation } from './useBubbleFoundation';
...
// 使用 useBubbleFoundation 获取公共逻辑
const { bubbleClasses, isEmptyAvatar } = useBubbleFoundation({ props: bubbleProps });
</script>
